...
const primeraAtencionDental = document.getElementById(
  "primeraAtencionDental"
);
...
const ultimaAtencionDental = document.getElementById(
  "ultimaAtencionDental"
);

primeraAtencionRadiologia.innerHTML = `${radiologia[0].PACIENTE} - ${radiologia[0].PREVISION}`
primeraAtencionTraumatologia.innerHTML = `${radiologia[0].PACIENTE} - ${radiologia[0].PREVISION}`
primeraAtencionDental.innerHTML = `${radiologia[0].PACIENTE} - ${radiologia[0].PREVISION}`
